...
class KDTreeIndexMapper extends MapReduceBase
	...
	final static int max_block_size = 1024;
...
class KDTreeIndexReducer extends MapReduceBase
	...
	static int count = 0;
	@Override
	public void reduce(LongWritable key,Iterator<Rect> value,OutputCollector<LongWritable,KDTreeWritable> oc,Reporter rpt)throws IOException{
		count++;
